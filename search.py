...
def title_to_info(metadata):
    ...
    for element in metadata:
        dictionary[element[0]] = {'author':  element[1], 'timestamp':element[2], 'length':element[3]}
        index += 1
    return dictionary
...
def keyword_to_titles(metadata):
    dictionary = {}
    for element in metadata:
        for value in element[4]:
            if value not in dictionary:
                dictionary[value] = [element[0]]
            else:
                dictionary[value] = dictionary[value] + [element[0]]
...
def article_info(titles, title_to_info):
    ...
    for element in titles:
        dictionary[element] = {'author':title_to_info[element]['author'], 'timestamp':title_to_info[element]['timestamp'], 'length':title_to_info[element]['length']}
    return dictionary
...
def article_length(article_length, titles, title_to_info):
    ...
    for element in titles:
        ...
        if title_to_info[element]['length'] <= article_length:
...
#
# TODO Write code for #6 heret
def title_timestamp(titles, title_to_info):
    dictionary = {}
    for element in titles:
        dictionary[element] = title_to_info[element]['timestamp']
    return dictionary
...
def favorite_author(author, titles, title_to_info):
    for element in titles:
        if author == title_to_info[element]['author']:
            return True
    return False
